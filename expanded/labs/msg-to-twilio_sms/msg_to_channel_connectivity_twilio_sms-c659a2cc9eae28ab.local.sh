#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (twilio-sms).
...
#                   the gateway transforms it into the twilio-sms-native payload and
...
URL="https://ACdeadbeefdeadbeef:dkry5cjqx4bi@mock.unitysvc.dev/twilio/2010-04-01/Accounts/ACdeadbeefdeadbeef/Messages.json"
