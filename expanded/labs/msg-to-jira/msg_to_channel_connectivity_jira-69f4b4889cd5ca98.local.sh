#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (jira).
...
#                   the gateway transforms it into the jira-native payload and
...
URL="https://mock.unitysvc.dev/jira/rest/api/2/issue"
status=$(curl -sS --max-time 10 \
    -X POST \
    -H "Content-Type: application/json" \
    -d '{"source":"apprise","message":"connectivity check","description":"ping","details":{},"priority":"P3"}' \
