#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (spikesh).
...
#                   the gateway transforms it into the spikesh-native payload and
...
URL="https://mock.unitysvc.dev/spikesh/v1/notify"
