#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (ntfy).
...
#                   the gateway transforms it into the ntfy-native payload and
...
URL="https://mock.unitysvc.dev/ntfy/demo"
