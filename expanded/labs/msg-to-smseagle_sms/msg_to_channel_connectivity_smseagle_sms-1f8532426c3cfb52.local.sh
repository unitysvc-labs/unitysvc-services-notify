#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (smseagle-sms).
...
#                   the gateway transforms it into the smseagle-sms-native payload and
...
URL="https://mock.unitysvc.dev/smseagle_sms/index.php/jsonrpc"
status=$(curl -sS --max-time 10 \
    -X POST \
    -H "Content-Type: application/json" \
    -d '{"method": "sms.send_sms", "params": {"access_token": "test_key", "to": "+15551234567", "message": "connectivity check", "message_type": "sms"}}' \
