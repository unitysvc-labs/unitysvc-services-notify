#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (pushdeer).
...
#                   the gateway transforms it into the pushdeer-native payload and
