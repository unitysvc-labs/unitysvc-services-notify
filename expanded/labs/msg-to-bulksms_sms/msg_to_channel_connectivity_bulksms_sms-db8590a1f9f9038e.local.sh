#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (bulksms-sms).
...
#                   the gateway transforms it into the bulksms-sms-native payload and
...
URL="https://demo123user:demo123@mock.unitysvc.dev/bulksms/v1/messages"
status=$(curl -sS --max-time 10 \
    -X POST \
    -H "Content-Type: application/json" \
    -d '{"to": "+15551234567", "body": "connectivity check", "routingGroup": "STANDARD", "encoding": "TEXT", "deliveryReports": "ERRORS"}' \
