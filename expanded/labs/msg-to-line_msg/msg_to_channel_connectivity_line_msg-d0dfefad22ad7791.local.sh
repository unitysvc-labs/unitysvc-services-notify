#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (line-msg).
...
#                   the gateway transforms it into the line-msg-native payload and
...
URL="https://mock.unitysvc.dev/line/v2/bot/message/push"
status=$(curl -sS --max-time 10 \
    -X POST \
    -H "Content-Type: application/json" \
    -d '{"to":"Utest","messages":[{"type":"text","text":"connectivity check"}]}' \
