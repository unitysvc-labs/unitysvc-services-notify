...
# Code example for a UnitySVC Notify gateway-transformer channel (pushy).
...
#                   gateway transforms it into the pushy-native payload.
...
response = httpx.post(
    "https://mock.unitysvc.dev/pushy/push?api_key=demo123",
