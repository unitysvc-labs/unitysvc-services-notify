#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (brevo-email).
...
#                   the gateway transforms it into the brevo-email-native payload and
...
URL="https://mock.unitysvc.dev/brevo/v3/smtp/email"
