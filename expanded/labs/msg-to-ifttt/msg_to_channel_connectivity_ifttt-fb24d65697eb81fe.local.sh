#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (ifttt).
...
#                   the gateway transforms it into the ifttt-native payload and
...
URL="https://mock.unitysvc.dev/ifttt/trigger/demoevent/with/key/demo123"
status=$(curl -sS --max-time 10 \
    -X POST \
    -H "Content-Type: application/json" \
    -d '{"value1": "connectivity check", "value2": "ping", "value3": "info"}' \
