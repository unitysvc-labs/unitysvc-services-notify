#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (burstsms-sms).
...
#                   the gateway transforms it into the burstsms-sms-native payload and
...
URL="https://demo123:demo123@mock.unitysvc.dev/burstsms_sms/send-sms.json"
