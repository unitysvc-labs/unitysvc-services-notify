#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (elks-sms).
...
#                   the gateway transforms it into the elks-sms-native payload and
...
URL="https://mock.unitysvc.dev/elks_sms/a1/sms"
