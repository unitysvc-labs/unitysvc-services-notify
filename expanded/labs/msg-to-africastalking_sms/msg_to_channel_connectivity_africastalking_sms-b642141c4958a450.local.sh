#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (africastalking-sms).
...
#                   the gateway transforms it into the africastalking-sms-native payload and
...
URL="https://mock.unitysvc.dev/africastalking_sms/version1/messaging"
