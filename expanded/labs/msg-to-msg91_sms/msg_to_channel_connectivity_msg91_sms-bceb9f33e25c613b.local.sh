#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (msg91-sms).
...
#                   the gateway transforms it into the msg91-sms-native payload and
...
URL="https://mock.unitysvc.dev/msg91_sms/api/v5/flow/"
status=$(curl -sS --max-time 10 \
    -X POST \
    -H "Content-Type: application/json" \
    -d '{"template_id": "test_tmpl", "short_url": 0, "recipients": [{"mobiles": "15551234567", "body": "connectivity check", "type": "info"}]}' \
