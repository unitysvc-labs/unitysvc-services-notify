...
status=$(curl -sS --max-time 10 \
    ...
    -d '{"urls":"nctalks://nextcloudtalkuser:nextcloudtalkpass@notify.example.com/nextcloudtalktargetroomidxyz123","title":"connectivity check","body":"ping","type":"info","format":"text"}' \
