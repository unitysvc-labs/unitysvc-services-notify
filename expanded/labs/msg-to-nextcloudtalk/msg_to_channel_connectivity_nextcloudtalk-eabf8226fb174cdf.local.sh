#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (nextcloudtalk).
...
#                   the gateway transforms it into the nextcloudtalk-native payload and
...
URL="https://mock.unitysvc.dev/nextcloudtalk/ocs/v2.php/apps/spreed/api/v1/chat/demoroom123"
