#!/bin/bash
# Connectivity test for a UnitySVC Notify gateway-transformer channel (d7networks-sms).
...
#                   the gateway transforms it into the d7networks-sms-native payload and
...
URL="https://mock.unitysvc.dev/d7networks_sms/messages/v1/send"
